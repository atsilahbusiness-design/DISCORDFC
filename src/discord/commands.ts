...
export const commandDefinitions = [
  ...
  new SlashCommandBuilder().setName('versus-bid').setDescription('Ajukan bid coin pada listing Deal Versus').addStringOption((option) => option.setName('listing_id').setDescription('ID listing dari Versus Market').setRequired(true)).addIntegerOption((option) => option.setName('amount').setDescription('Jumlah coin bid').setRequired(true).setMinValue(1)),
