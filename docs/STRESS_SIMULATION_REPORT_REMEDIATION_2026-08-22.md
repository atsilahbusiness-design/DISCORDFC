...
Generated: 2026-08-22T07:38:00.550Z
...
Raw machine-readable results are stored in `docs/STRESS_SIMULATION_RESULTS_REMEDIATION_2026-08-22.json`. The Versus run includes 1,200 legal submissions and 1,200 ledger reconciliation checks.
